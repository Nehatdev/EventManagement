  ...
  return (
    <div className="about-container">
      ...
      <section className="section">
        <h2>Meet Our Team</h2>
        <p>
          Our team consists of talented event planners, designers, and coordinators. Led by our founder, Neha, we work collaboratively to bring your vision to life, whether it's a corporate event, wedding, or social gathering.
        </p>
      </section>
